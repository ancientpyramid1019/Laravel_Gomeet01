    ...
    <div class="col-xl-8 col-lg-12 col-md-12 col-12">
        <div class="site-card">
            <div class="site-card-header">
                ...
                <a data-bs-toggle="modal" data-bs-target="#mailConnection" href="javascript:void(0);" class="title"> <i icon-name="mail-check"></i> <h3 class="title active">{{ __('Connection Check') }}</h3></a>
            </div>
